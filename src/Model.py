...
class Model():
    ...
    def setupCNN(self):
        ...
        kernelVals = [5, 5, 5, 3, 3, 3]
        featureVals = [1, 32, 64, 128, 256, 256, 512]
        strideVals = poolVals = [(2, 2), (2, 2), (1, 2), (1, 2), (1, 2), (1, 1)]
    ...
    def setupCTC(self):
        ...
        if self.decoderType == DecoderType.BestPath:
            ...
            wordChars = open('../src/data/wordCharList.txt').read().splitlines()[0]
    ...
    def save(self):
        "save model to file"
        self.snapID += 1
        self.saver.save(self.sess, '../src/model/snapshot', global_step=self.snapID)
